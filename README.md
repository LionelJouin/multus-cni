...
docker build -t localhost:5000/k8snetworkplumbingwg/multus-cni:latest-amd64-debug -f images/Dockerfile.thick . ; \
docker push localhost:5000/k8snetworkplumbingwg/multus-cni:latest-amd64-debug